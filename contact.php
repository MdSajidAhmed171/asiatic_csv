...
<html lang="en">
  <head>
    ...
    <title>Ornage Toolz | Contact List</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><i class="fa fa-bolt"></i> <span>Orange Toolz !</span></a>
            </div>
                            ...
                            <div class="card-box table-responsive">
                              ...
                              <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                include 'config.php';
                                    ...
                                    $sql = "SELECT * FROM `valid_contact` Where user_id = $user_id AND file_name = '$file' AND group_name = '$group_name';";
